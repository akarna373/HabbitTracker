...
// What Today used to show before it became a dashboard: today's progress card and one
// swipeable tile per habit. The Habits tile on Today opens this screen.
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <Card>
            ...
            <Text style={styles.emptyBody}>Go back and tap + to add your first small change.</Text>
          </Card>
        }
      />
    </SafeAreaView>
